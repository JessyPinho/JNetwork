...
// Icons
import { IoCloseSharp, IoPencilSharp, IoArrowBackOutline } from "react-icons/io5";
...
import "./styles/question_audio.css";

//import "./../screens/styles/video.css";
...
*/
  ...
  const [secondStepAudio, setSecondStepAudio] = useState(false);
...
// The optionnal file has been removed for now. Coming back soon!
    ...
    if (optionalFile)
      await addDoc(questionsCollectionRef, { creationDate: currentDate, username, uid, title, description, category, audiourl: blobUrl, thumbnailURL: category + ".png", optionalFile: optionalFile.name});
    else
      await addDoc(questionsCollectionRef, { creationDate: currentDate, username, uid, title, description, category, audiourl: blobUrl, thumbnailURL: category + ".png", optionalFile: ""});    updateCoinAmount();
...
//    Called first when submitting question to DB
  ...
  return (
    <div id="ask-question-path">
        ...
        <div id="ask-audio-question-container" className="ask-question-signle-path">
...
{firstStepQuestion &&  
            <div className="step_question_container">
              ...
              <div id="step-one-btn-container" className="step-one-btn-container-class">
                ...
                <button className="upload-question-btn" onClick={ askAudioQuestion }>Suivant</button>
              </div>
            </div>
...
{secondStepAudio && <div className="step_question_container second-step-question">
            ...
            <div id="step-two-content-container">
              ...
              <AudioElement source={mediaBlobUrl} />
...
{thirdStepQuestion && 
            ...
            <div className="third-step-question">
              <div id="recap-more-info-audio">
                <div className="recap-audio-title">
                  <span id="recap-more-info-audio__title">{title}</span>
                </div>
...
{mediaBlobUrl && <button onClick={stageData} className="third-step-question__btns-btn submit-question-btns">Publier</button> }
              </div>
            </div>
}
        </div>
...
export default AskAudioQuestion;